-- mixed.lua — 混合负载 (模拟真实流量: 80% 读 + 20% 写)
-- 用法: WRK_TOKEN=<jwt> wrk -t4 -c200 -d60s -s mixed.lua http://localhost:8080
...
local scenarios = {
    ...
    -- 20% 写
    { m="POST", path="/api/articles/ID/comments",     body='{"content":"压测评论"}', weight=8  },
